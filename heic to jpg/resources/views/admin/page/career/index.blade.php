...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">{{ __('Career') }}</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">{{ __('Career') }}</li>
            </ol>
            @can('careerPage-create')
            <a href="{{ route('pages.career.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    ...
                                    @endcan
                                    @can('careerPage-edit')
                                    <a class="dropdown-item" href="{{ route('pages.career.edit',$page->id) }}">
                                        <i class="fa fa-fw fa-edit"></i> Edit
                                    </a>
                                    @endcan
                                    @if($page->status == 'UnPublish')
                                    @can('careerPage-publish')
