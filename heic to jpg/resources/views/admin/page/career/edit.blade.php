...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Edit Career</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('pages.career.index') }}">Career</a></li>
                <li class="breadcrumb-item active">Edit</li>
            </ol>
            <a href="{{ route('pages.career.index') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
<div class="card wizard-content">
    <div class="card-body">
        <h4 class="card-title">Update Page with Multistep</h4>
        <form method="POST" action="{{ route('pages.update', $page->id) }}" class="validation-wizard wizard-circle" role="form" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
            @include('admin.page.career.form') 
        </form>
    </div>
</div>
@endsection
...
<script>
    ...
    $(".validation-wizard").validate({
        ...
        messages:{
            ...
            template:{
                required: "Please chose a template.",
                remote: jQuery.validator.format("{0} template is already exist.")
            },
        },
    })
</script>
