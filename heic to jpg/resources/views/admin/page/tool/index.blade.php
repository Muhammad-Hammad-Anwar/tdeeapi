...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">{{ __('Tool') }}</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">{{ __('Tool') }}</li>
            </ol>
            @can('toolPage-create')
            <a href="{{ route('pages.tool.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">{{ __('Tool Pages') }}</h4>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    ...
                                    @endcan
                                    @can('toolPage-edit')
                                    <a class="dropdown-item" href="{{ route('pages.tool.edit',$page->id) }}">
                                        <i class="fa fa-fw fa-edit"></i> Edit
                                    </a>
                                    @endcan
                                    @if($page->status == 'UnPublish')
                                    @can('toolPage-publish')
