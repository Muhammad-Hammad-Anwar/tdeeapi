...
<section>
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('category') }}
            {{ Form::select('parent_id', toolCategories(), $page->parent_id, ['class' => 'form-control' . ($errors->has('parent_id') ? ' is-invalid' : ''), 'placeholder' => '--Select--','required']) }}
