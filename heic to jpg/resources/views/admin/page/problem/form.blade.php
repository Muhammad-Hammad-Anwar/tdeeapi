...
<section>
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('category') }}
            {{ Form::select('parent_id', problemCategories(), $page->parent_id, ['class' => 'form-control' . ($errors->has('parent_id') ? ' is-invalid' : ''), 'placeholder' => '--Select--','required']) }}
...
<section>
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::select('relatedPages[]', $relatedProblems, '', ['class' => '', 'id' => 'public-methods' . ($errors->has('relatedPages') ? ' relatedPages' : ''), 'data-placeholder' => '--Select--','multiple']) }}
