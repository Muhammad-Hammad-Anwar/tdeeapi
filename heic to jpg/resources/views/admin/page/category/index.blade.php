...
@section('breadcrumb')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">{{ __('Category') }}</h4>
    </div>
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            ...
            @can('categoryPage-create')
            <a href="{{ route('pages.category.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    @can('categoryPage-view')
                                    <a class="dropdown-item" href="{{ url($page->slug) }}" target="_blank">
                                        <i class="fa fa-fw fa-eye"></i> Show
                                    </a>
                                    @endcan
                                    @can('categoryPage-edit')
                                    <a class="dropdown-item" href="{{ route('pages.category.edit',$page->id) }}">
                                        <i class="fa fa-fw fa-edit"></i> Edit
                                    </a>
                                    @endcan
                                    @if($page->status == 'UnPublish')
                                    @can('categoryPage-publish')
