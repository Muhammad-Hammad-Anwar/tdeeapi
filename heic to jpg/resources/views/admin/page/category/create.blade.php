    ...
    <div class="col-md-7 align-self-center text-end">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb justify-content-end">
                ...
                <li class="breadcrumb-item"><a href="{{ route('pages.category.index') }}">Category</a></li>
                <li class="breadcrumb-item active">Create</li>
            </ol>
            <a href="{{ route('pages.category.index') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
...
<div class="card wizard-content">
    <div class="card-body">
        <h4 class="card-title">Craete Category Page with Multistep</h4>
