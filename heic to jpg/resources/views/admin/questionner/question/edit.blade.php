...
<div class="col-md-5 align-self-center">
    <h4 class="text-themecolor">Edit Question</h4>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('questions.update', $question->id) }}" class="question" role="form" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
