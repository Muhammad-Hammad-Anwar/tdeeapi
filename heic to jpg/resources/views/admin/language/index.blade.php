...
<div class="col-md-7 align-self-center text-end">
    <div class="d-flex justify-content-end align-items-center">
        ...
        @can('language-create')
        <a href="{{ route('languages.create') }}" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn dropdown-menu-end">
                                    @can('language-view')
                                    <a class="dropdown-item" href="{{ route('languages.show',$language->id) }}">
